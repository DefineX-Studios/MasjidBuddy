 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.mb-client.staging
 */

const BUNDLE_ID = 'com.masjidbuddy'; // ios bundle id
const PACKAGE = 'com.masjidbuddy'; // android package name
const NAME = 'Masjid Buddy'; // app name
const EXPO_ACCOUNT_OWNER = 'definexstudios'; // expo account owner
const EAS_PROJECT_ID = '89f3bccd-045b-444b-a009-bf8e1bbc3b48'; // eas project id
